...
export default function MonthlyForecastOnlyChart({ data, type = "bar" }) {
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={350}>
            <BarChart data={chartData}>
              ...
              <XAxis dataKey="month" stroke="#64748b" fontSize={11} angle={-45} textAnchor="end" height={80} />
