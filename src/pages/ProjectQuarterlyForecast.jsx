...
import { format, startOfYear, endOfYear, startOfQuarter, endOfQuarter, eachQuarterOfInterval, parseISO } from "date-fns";

export default function ProjectQuarterlyForecast() {
  ...
  // Calculate quarterly actuals from transactions
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Quarterly Forecast & Actuals</p>
        </div>
